...
export default function InstagramView() {
    return (
        <div style={{margin: '0 auto'}} className="padded">
            <blockquote
                className="instagram-media"
                data-instgrm-permalink="https://www.instagram.com/frosted.by.nes/?utm_source=ig_embed&amp;utm_campaign=loading"
                ...
                <div style={{ padding: '16px' }}>
                    <a
                        href="https://www.instagram.com/frosted.by.nes/?utm_source=ig_embed&amp;utm_campaign=loading"
                        style={{
                            background: '#FFFFFF',
                            lineHeight: 0,
                            padding: '0 0',
                    ...
                    >
                        ...
                        <div style={{ paddingTop: '8px' }}>
                            <div style={{ color: '#3897f0', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal; font-weight:550', lineHeight: '18px' }}>
                    ...
                    <p style={{color:'#c9c8cd', fontFamily:'Arial,sans-serif', fontSize:'14px', lineHeight:'17px', marginBottom:0, marginTop:'8px', overflow:'hidden', padding:'8px 0 7px', textAlign:'center', textOverflow:'ellipsis', whiteSpace:'nowrap'}}>
                        <a href="https://www.instagram.com/frosted.by.nes/?utm_source=ig_embed&amp;utm_campaign=loading" style={{color:'#c9c8cd', fontFamily:'Arial,sans-serif', fontSize:'14px', fontStyle:'normal', fontWeight:'normal', lineHeight:'17px'}} target="_blank" rel="noreferrer">
                            Frosted by Nes
                            </a> 
                            (@<a href="https://www.instagram.com/frosted.by.nes/?utm_source=ig_embed&amp;utm_campaign=loading" style={{color:'#c9c8cd', fontFamily:'Arial,sans-serif', fontSize:'14px', fontStyle:'normal', fontWeight:'normal', lineHeight:'17px'}} target="_blank" rel="noreferrer">
                                frosted.by.nes
                                </a>) • Instagram photos and videos</p></div></blockquote>
        </div>
    )
}